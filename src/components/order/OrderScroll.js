...
export default function OrderScroll({ foodCategoryRef }) {
  ...
  function scrollToFood(i) {
    if (foodCategoryRef.current)
      foodCategoryRef.current[i].scrollIntoView({
        behavior: "smooth",
        block: "nearest",
        inline: "end",
      });
  ...
  return (
    <div className={styles["bigger-cont"]}>
      <div
      ...
      <div className={styles["main-cont"]} onScroll={scrollHandler}>
        ...
        <div className={styles.item} onClick={() => scrollToFood(1)}>
